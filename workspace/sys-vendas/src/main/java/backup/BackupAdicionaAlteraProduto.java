...
//@WebServlet("/adicionaAlteraProduto")
public class BackupAdicionaAlteraProduto extends HttpServlet {
	...
	//fim da imagem
		...
		//Se adicionar mais unidades, ele vai somar
		int qtdEntrada = Integer.parseInt(req.getParameter("qtdEntrada"));
		int qtdAdicional = Integer.parseInt(req.getParameter("qtdAdicional"));
		
		estoque.setQtdEntrada( qtdEntrada+qtdAdicional );
