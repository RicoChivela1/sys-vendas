...
<form action="busca-produto.jsp" method="post">
	...
	<c:choose>	
		<c:when test="${empty produtos}">
			<button  id="btnBuscaTodos" value="busca-produto.jsp?filtro=" type="submit" name="btnBuscaTodos" class="btn btn-outline-secondary" title="Listar todos" style="float: right;"> <i class="fa fa-search" aria-hidden="true" > Listar todos</i></button>
		</c:when>
	</c:choose>		
</form>	
