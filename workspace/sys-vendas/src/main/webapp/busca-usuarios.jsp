...
<form action="busca-usuario.jsp" method="post">
	...
	<c:choose>	
		<c:when test="${empty usuarios}">
				<button  id="btnBuscaTodos" value="busca-usuario.jsp?filtro=" type="submit" name="btnBuscaTodos" class="btn btn-outline-secondary" title="Listar todos." style="float: right;"> <i class="fa fa-search" aria-hidden="true" > Listar todos</i></button>
		</c:when>
	</c:choose>	
</form>	
