			...
			<div class="esquerda">
						...
						<div class="caixa">
							...
							<select name="fornecedorId" style="width: 170px; height: 38px" class="form-control" >
      						...
      						<span class="input-group-btn" >
        						<button class="btn btn-default" type="button"><a href="/sys-vendas/cadastrar-fornecedor.jsp">&#10010;</a></button>
      						</span>
						</div>
					</div>
					...
					<div class="direita">
						<div class="caixa">
							...
							<span class="input-group-btn" >
        						<button class="btn btn-default" type="button"><a href="/sys-vendas/cadastrar-categoria.jsp">&#10010;</a></button>
      						</span>						
				...
				<div class="caixa">
						...
						<input type="text" name="nome"  size="40" class="form-control" required="required" >
						...
						<div class="esquerda">
							...
							<label for="qtdDisponivel" style="margin-top: 5px;">Quantidade
								...
								<input type="text" name="qtdDisponivel" value="0"
							...
							<label for="qtdEntrada" style="margin-top: 5px; color: maroon;">Adicionar Quantidade:</label> 
								<input type="text" name="qtdEntrada" value="" size="10" class="form-control" required="required" 
