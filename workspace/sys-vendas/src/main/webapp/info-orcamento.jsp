  ...
  <form action="" method="post">	
	...
	<div class="table-responsive">
		<table class="table table-hover">
	      ...
	      <td> 
		  <div class="btnAcoes">			      		
		    <button type="submit" name="info" value=""  class="btn btn-outline-info" title="Veja maiores informações sobre um produto e realize uma venda."> <i class="fa fa-info-circle" ></i> Info</button>
		  </div>
	      </td>
	    </tr>
		  </tbody>
