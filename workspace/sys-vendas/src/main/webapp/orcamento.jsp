		 ...
		 <c:choose>
		 	<c:when test="${empty sessaoCliente.nome}"> 
				<div id="btnFormOrca">
					<span class="input-group-btn">
						<a href="busca-cliente.jsp?filtro=" id="linkSelect"  title="Adicione um Cliente">&#10010; Adicionar Cliente</a>
					</span>
				</div>
		 	...
		 	<input id ="fieldsMedio" type="text" name="nomeCliente" value="${sessaoCliente.nome} ${sessaoCliente.sobreNome}" class="form-control"/>
				...
				<div id="btnFormOrca">
					...
					<span class="input-group-btn">
						<a href="busca-cliente.jsp?filtro=" id="linkSelect"  title="Adicione outro cliente">&#10010; Adicionar Cliente</a>
					</span>
		...
		<select  name="parcelas"  id="selectDeProdutos" class="form-control" >
            ...
            <div class="col-md-12 stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  <h4 class="card-description">PRODUTO
                  </h4>
		  ...
		  <c:choose> 
			 ...
			 <c:when test="${empty carroCompras}"> 
				<div id="btnFormOrca">
					<span class="input-group-btn">
					<a href="busca-produto.jsp?filtro=" id="linkSelect"  title="Adicione um produto aqui ">&#10010; Adicionar Produto</a>
				</span>
